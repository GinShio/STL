...
struct _VectorBase {
 ...
 protected:
  struct _VectorImpl : public _AllocatorType {
    ...
    void __swap(_VectorImpl& _impl) {
      ::std::swap(_impl._begin, this->_begin);
      ::std::swap(_impl._end, this->_end);
      ::std::swap(_impl._finish, this->_finish);
    }
  };
 ...
 public:
  ...
  _VectorBase(const ::std::size_t& _cap)
      : _VectorBase(_cap, _AllocatorType()) {}
  ...
  _VectorBase(_VectorBase&& _other) noexcept
 ...
 protected:
  ...
  static constexpr ::std::size_t __max_size() noexcept {
    return static_cast<::std::size_t>(
        ::std::numeric_limits<::std::ptrdiff_t>::max()) / sizeof(_ValueType);
  }
};
}  // namespace __container_base
...
class vector : protected __container_base::_VectorBase<T, Allocator> {
 ...
 public:
  ...
  template <typename InputIt,
            typename = typename ::std::enable_if<
              ::ginshio::stl::is_iterator<InputIt>::value &&
  ...
  vector(const vector& other)
    ...
    try {
      _impl._end = ::ginshio::stl::uninitialized_copy(
          other.begin(), other.end(), _impl._begin);
    } catch (...) {
      _Base::__put(_impl);
      throw;
    }
  ...
  vector(::std::initializer_list<value_type> ilist,
    ...
    try {
      _impl._end = ::ginshio::stl::uninitialized_copy(
          ilist.begin(), ilist.end(), _impl._begin);
    } catch (...) {
      _Base::__put(_impl);
      throw;
    }
 ...
 public:
  void assign(size_type count, const value_type& value) {
    ...
    if (this->size() < count) {
      ...
      ::ginshio::stl::destroy(
           ::ginshio::stl::fill_n(_impl._begin, count, value), _impl._end);
      _impl._end = _impl._begin + count;
    }
  }
  template <typename InputIt,
            typename = typename ::std::enable_if<
              ::ginshio::stl::is_iterator<InputIt>::value>::type>
 ...
 public:
  ...
  void reserve(size_type new_cap) {
    ...
    _Base::__get(new_cap, _new);
    _new._end = ::ginshio::stl::uninitialized_move_n(
        _impl._begin, _impl._end - _impl._begin, _new._begin).second;
    _Base::__put(_impl);
    _impl.__swap(_new);
  }
 ...
 public:
  ...
  void resize(size_type count, const value_type& value) {
    ...
    if (_size < count) {
      ::ginshio::stl::__check_length_error("vector::resize", count,
                                           _Base::__max_size());
 ...
 private:
  ...
  void __assign_range_dispatch(_ForwardIt _first, _ForwardIt _last,
    ...
    const size_type _len =
        static_cast<size_type>(::std::distance(_first, _last));
    if (_len == 0) {
      return;
    }
    ...
    ::ginshio::stl::destroy(
         ::ginshio::stl::copy_n(_first, _len, _impl._begin).second,
         _impl._end);
 ...
 private:
  ...
  void __range_init(_ForwardIt _first, _ForwardIt _last,
    ...
    _impl._end =
        ::ginshio::stl::uninitialized_copy(_first, _last, _impl._begin);
  }
};
